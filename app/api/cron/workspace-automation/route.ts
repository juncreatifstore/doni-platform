...
export async function GET(req:NextRequest){
 ...
 try{const workspace=await runWorkspaceAutomation();const notifications=await runInternalNotificationAutomation();return NextResponse.json({success:true,workspace,notifications});}
