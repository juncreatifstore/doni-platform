...
export async function GET(req:Request){
 ...
 await db.appSetting.create({data:{key:`facebook.ads.oauth.state.${state}`,category:'Meta Ads OAuth',value:{state,userId:auth.user.id,expiresAt,stepUpVerified:true} as any}});
