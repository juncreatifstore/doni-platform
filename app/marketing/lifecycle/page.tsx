...
export default async function Page() {
  ...
  const workspace = await getMarketingLifecycleWorkspace();
  return (
    <DoniShell title="Cycle client unifié" active="/marketing/lifecycle" user={user}>
      <MarketingLifecycle workspace={workspace} />
    </DoniShell>
  );
}
