...
type WinningLearning={id:string;experimentId:string;winner:'A'|'B';campaignId:string;campaignTitle:string;metric:string;controlCampaignId:string;variantCampaignId:string|null;resultNote:string|null;statsA:any;statsB:any;promotedAt:string;promotedBy:string;status:'APPROVED_LEARNING';autoApply:false};
