...
const baseItems=[['/overview','🏠','Overview'],['/live-ops','🚀','Live Ops'],['/customers','🧑‍💼','Clients'],['/ticketing','🎫','Ticketing'],['/manual-payments','🧾','Paiements manuels'],['/post-booking','📂','Post-Booking'],['/flight-ops','🛫','Flight Ops'],['/checkin','✅','Check-in'],['/baggage','🧳','Bagages'],['/inventory','🗂️','Inventaire'],['/flow-tracker','🧭','Flow Tracker']];
